...
<path d="M18.47 6.97L5.93 11.8c-.85.34-.84.82-.15 1.02l3.22 1.01 1.23 3.84c.16.45.08.63.56.63.37 0 .53-.16.73-.36l1.57-1.53 3.26 2.4c.6.34 1.03.16 1.18-.56l2.13-10.06c.2-.88-.34-1.23-1.19-.9z" fill="white"/>
</svg>
);
    ...
    <footer className="footer">
      <div className="footer-inner">
        ...
        <div className="footer-socials">
          <a href="https://t.me/unreel_analyser_bot" target="_blank" rel="noopener noreferrer" className="social-link social-link-telegram" aria-label="Telegram Bot">
            <TelegramIcon />
          </a>
